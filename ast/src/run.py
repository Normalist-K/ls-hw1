...
parser.add_argument("--dataset", type=str, default="audioset", help="the dataset used", choices=["audioset", "esc50", "speechcommands", "med"])
...
if args.model == 'ast':
    ...
    norm_stats = {'med':[-3.4244215, 4.062329], 'audioset':[-4.2677393, 4.5689974], 'esc50':[-6.6268077, 5.358466], 'speechcommands':[-6.845978, 5.5654526]}
    target_length = {'med':1024, 'audioset':1024, 'esc50':512, 'speechcommands':128}
    # if add noise for data augmentation, only use for speech commands
    noise = {'med': False, 'audioset': False, 'esc50': False, 'speechcommands':True}
...
train(audio_model, train_loader, val_loader, args, infer_loader)
