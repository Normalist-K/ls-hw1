...
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'med'}

train_loader = torch.utils.data.DataLoader(
    dataloader.AudiosetDataset('/shared/youngkim/dataset/datafiles/esc_train_data_0.json', label_csv=None,
